...
def get_starter_prompts(max_count: int = 5, use_llm: bool = False, refresh_cache: bool = False) -> List[Dict[str, str]]:
    """
...
def get_shuffled_starters(max_count: int = 5, use_llm: bool = False, use_random: bool = False) -> List[cl.Starter]:
    """
