...
ICONS_PROVIDER_MAP: Dict[str, str] = {
    ...
    "Cohere": "./vtai/resources/cohere.ico",
    "Mistral": "./vtai/resources/huggingface.ico",  # Using HuggingFace icon for Mistral
    "DeepSeek": "./vtai/resources/huggingface.ico",  # Using HuggingFace icon for DeepSeek
    "OpenRouter": "./vtai/resources/openrouter.ico",
    # OpenAI model-specific mappings
    "gpt-4o-mini": "./vtai/resources/chatgpt-icon.png",
    "gpt-4o": "./vtai/resources/chatgpt-icon.png",
    "o1": "./vtai/resources/chatgpt-icon.png",
    "gpt-4.5-preview": "./vtai/resources/chatgpt-icon.png",
    "o3-mini": "./vtai/resources/chatgpt-icon.png",
    "o1-mini": "./vtai/resources/chatgpt-icon.png",
    "o1-pro": "./vtai/resources/chatgpt-icon.png",
    "gpt-4": "./vtai/resources/chatgpt-icon.png",
    "gpt-4-turbo": "./vtai/resources/chatgpt-icon.png",
    # OpenAI TTS and Image models
    "tts-1": "./vtai/resources/chatgpt-icon.png",
    "tts-1-hd": "./vtai/resources/chatgpt-icon.png",
    "gpt-4o-mini-tts": "./vtai/resources/chatgpt-icon.png",
    "dall-e-3": "./vtai/resources/chatgpt-icon.png",
    # Anthropic model-specific mappings
    "claude-3-7-sonnet-20250219": "./vtai/resources/claude-ai-icon.png",
    "claude-3-5-sonnet-20241022": "./vtai/resources/claude-ai-icon.png",
    "claude-3-5-haiku-20241022": "./vtai/resources/claude-ai-icon.png",
    ...
    # Google model-specific mappings
    "gemini/gemini-2.0-pro": "./vtai/resources/google-gemini-icon.png",
    "gemini/gemini-2.0-flash": "./vtai/resources/google-gemini-icon.png",
    "gemini/gemini-2.0-flash-exp": "./vtai/resources/google-gemini-icon.png",
    ...
    # DeepSeek model-specific mappings
    "deepseek/deepseek-reasoner": "./vtai/resources/huggingface.ico",
    "deepseek/deepseek-chat": "./vtai/resources/huggingface.ico",
    "deepseek/deepseek-coder": "./vtai/resources/huggingface.ico",
    # OpenRouter model-specific mappings
    "openrouter/deepseek/deepseek-r1:free": "./vtai/resources/huggingface.ico",
    "openrouter/deepseek/deepseek-r1": "./vtai/resources/huggingface.ico",
    "openrouter/deepseek/deepseek-chat-v3-0324:free": "./vtai/resources/huggingface.ico",
    "openrouter/deepseek/deepseek-chat-v3-0324": "./vtai/resources/huggingface.ico",
    "openrouter/anthropic/claude-3.7-sonnet:thinking": "./vtai/resources/claude-ai-icon.png",
    "openrouter/anthropic/claude-3.7-sonnet": "./vtai/resources/claude-ai-icon.png",
    "openrouter/google/gemini-2.5-pro-exp-03-25:free": "./vtai/resources/google-gemini-icon.png",
    "openrouter/google/gemini-2.5-pro-preview-03-25": "./vtai/resources/google-gemini-icon.png",
    "openrouter/google/gemini-2.0-flash-thinking-exp:free": "./vtai/resources/google-gemini-icon.png",
    "openrouter/google/gemini-2.0-flash-exp:free": "./vtai/resources/google-gemini-icon.png",
    "openrouter/google/gemma-3-27b-it:free": "./vtai/resources/google-gemini-icon.png",
    "openrouter/meta-llama/llama-4-maverick:free": "./vtai/resources/openrouter.ico",
    "openrouter/meta-llama/llama-4-maverick": "./vtai/resources/openrouter.ico",
    "openrouter/meta-llama/llama-4-scout:free": "./vtai/resources/openrouter.ico",
    "openrouter/meta-llama/llama-4-scout": "./vtai/resources/openrouter.ico",
    "openrouter/qwen/qwq-32b:free": "./vtai/resources/openrouter.ico",
    "openrouter/qwen/qwq-32b": "./vtai/resources/openrouter.ico",
    "openrouter/qwen/qwen2.5-vl-32b-instruct:free": "./vtai/resources/openrouter.ico",
    "openrouter/qwen/qwen-2.5-coder-32b-instruct": "./vtai/resources/openrouter.ico",
    "openrouter/mistralai/mistral-small-3.1-24b-instruct:free": "./vtai/resources/huggingface.ico",
    "openrouter/mistralai/mistral-small-3.1-24b-instruct": "./vtai/resources/huggingface.ico",
    "openrouter/mistralai/mistral-7b-instruct": "./vtai/resources/huggingface.ico",
    "OpenRouter - Mistral 7b instruct Free": "./vtai/resources/huggingface.ico",
    # Ollama model-specific mappings
    "ollama/deepseek-r1:1.5b": "./vtai/resources/ollama.png",
    "ollama/deepseek-r1:7b": "./vtai/resources/ollama.png",
    "ollama/deepseek-r1:8b": "./vtai/resources/ollama.png",
    "ollama/deepseek-r1:14b": "./vtai/resources/ollama.png",
    "ollama/deepseek-r1:32b": "./vtai/resources/ollama.png",
    "ollama/deepseek-r1:70b": "./vtai/resources/ollama.png",
    "ollama/qwen2.5-coder": "./vtai/resources/ollama.png",
    "ollama/qwen2.5-coder:14b": "./vtai/resources/ollama.png",
    "ollama/qwen2.5-coder:32b": "./vtai/resources/ollama.png",
    "ollama/llama3.2-vision": "./vtai/resources/ollama.png",
    "ollama/llama3": "./vtai/resources/ollama.png",
    "ollama/llama3.1": "./vtai/resources/ollama.png",
    "ollama/llama3.2": "./vtai/resources/ollama.png",
    "ollama/phi3": "./vtai/resources/ollama.png",
    "ollama/command-r": "./vtai/resources/ollama.png",
    "ollama/command-r-plus": "./vtai/resources/ollama.png",
    "ollama/mistral": "./vtai/resources/ollama.png",
    "ollama/mixtral": "./vtai/resources/ollama.png",
    # Mistral model-specific mappings
    "mistral/mistral-small-latest": "./vtai/resources/huggingface.ico",
    "mistral/mistral-large-latest": "./vtai/resources/huggingface.ico",
    # Groq model-specific mappings
    "meta-llama/llama-4-scout-17b-16e-instruct": "./vtai/resources/groq.ico",
    ...
    # Cohere model-specific mappings
